...
if position_side == "Buy" and position_value != 0:
    ...
    set_buy_postion = client.LinearOrder.LinearOrder_new(side="Sell",symbol="BTCUSDT",order_type="Limit",qty=qty,price=ask_price,time_in_force="GoodTillCancel",reduce_only=False, close_on_trigger=False).result()
